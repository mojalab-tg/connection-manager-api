...
module.exports = {
  ...
  vault: {
    ...
    mounts: {
      ...
      dfspClientCertBundle: env.get('VAULT_MOUNT_DFSP_CLIENT_CERT_BUNDLE').default('secrets/dfspClientCertBundle').asString(),
      dfspInternalIPWhitelistBundle: env.get('VAULT_MOUNT_DFSP_INT_IP_WHITELIST_BUNDLE').default('secrets/dfspInternalIPWhitelistBundle').asString(),
      dfspExternalIPWhitelistBundle: env.get('VAULT_MOUNT_DFSP_EXT_IP_WHITELIST_BUNDLE').default('secrets/dfspExternalIPWhitelistBundle').asString(),
    },
