...
exports.getValidationConfig = (config) => ({
  ...
  serverCertValidations: [
    ...
    // config.keyLength === 4096 ? VALIDATION_CODES.CERTIFICATE_PUBLIC_KEY_LENGTH_4096.code : 
    VALIDATION_CODES.CERTIFICATE_PUBLIC_KEY_LENGTH_2048.code,// custom: fixer le min lenght des certe a 2048
